...
theorem mul_inv_cancel (a : G) : a * a⁻¹ = 1 := by
  have h : (a * a⁻¹)⁻¹ * (a * a⁻¹ * a * a⁻¹) = 1 := by
    rw [mul_assoc a, inv_mul_cancel, mul_assoc, one_mul]
    rw [inv_mul_cancel]
  rw [← h]
...
theorem mul_inv_rev (a b : G) : (a * b)⁻¹ = b⁻¹ * a⁻¹ := by
  rw [← mul_one (a * b)⁻¹, ← mul_one (b⁻¹ * a⁻¹),
      ← mul_inv_cancel (a * b), ← mul_assoc,
      inv_mul_cancel, ← mul_assoc, ← mul_assoc, mul_assoc _ _ a,
      inv_mul_cancel, mul_one, inv_mul_cancel]
